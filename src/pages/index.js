...
import tweets_time from '../assets/jsons/tweets_time.json';
import most_common from '../assets/images/200_most_common_words.png';
...
import most_common_json from '../assets/jsons/most_common.json';
import sent_per_day_json from '../assets/jsons/sent_per_day.json';
import ov_sentiment_per_day from '../assets/jsons/ov_sentiment_per_day.json';
import ov_polarity_per_day from '../assets/jsons/ov_polarity_per_day.json';
import geo_loc_json from '../assets/jsons/geo_loc.json';
        ...
        <div id="main">
          <section id="intro" className="main special">
            ...
            </header>
            {
              ...
              && (
              <Plot
                data={[{ x: tweets_time, type: 'histogram', marker: { color: 'blue', opacity: 0.75 } }]}
          ...
          <section id="first" className="main special">
            ...
            <div align="center"><img src={most_common} alt="" style={{ width: '70%' }} /></div>
            <p>Word-cloud of 200 most common keywords/hashtags</p>
            {
              typeof window !== 'undefined' && Plot
              && (
              <Plot
                data={most_common_json.data.map(el => ({
                  x: most_common_json.ticks,
                  y: el.y,
                  name: el.name,
                  type: 'scatter',
                }))}
                layout={{ xaxis: { ticktext: most_common_json.labels, tickvals: most_common_json.ticks, showgrid: true }, yaxis: { showticklabels: false } }}
                useResizeHandler
                style={{ width: '100%' }}
              />
              )
          ...
          <section id="second" className="main special">
            ...
            <h3 style={{ textAlign: 'left' }}><b>Overall Sentiment</b></h3>
            {
              ...
              && (
              <Plot
                data={ov_sentiment_per_day.data.map(el => ({
                  x: ov_sentiment_per_day.ticks,
                  y: el.y,
                  name: el.name,
                  type: 'bar',
                  marker: { color: el.color },
                }))}
                layout={{ xaxis: { ticktext: ov_sentiment_per_day.labels, tickvals: ov_sentiment_per_day.ticks }, barmode: 'relative', autosize: true }}
                useResizeHandler
                style={{ width: '100%' }}
              />
              )
            ...
            <p>Sentiment of tweets over time</p>
            {
              ...
              <Plot
                data={[{
                  x: ov_polarity_per_day.ticks,
                  y: ov_polarity_per_day.data,
                  type: 'scatter',
                  mode: 'lines+markers',
                  line: { shape: 'spline', smoothing: 0.75 },
                }]}
                layout={{ xaxis: { ticktext: ov_polarity_per_day.labels, tickvals: ov_polarity_per_day.ticks }, autosize: true }}
                useResizeHandler
                style={{ width: '100%' }}
              />
              )
            ...
            <p>Polarity of tweets over time</p>
            {
              ...
              && (
              <Plot
                data={sent_per_day_json.data.map(el => ({
                  x: sent_per_day_json.ticks,
                  y: el.y,
                  name: el.name,
                  type: 'scatter',
                  mode: 'lines+markers',
                ...
                layout={{ xaxis: { ticktext: sent_per_day_json.labels, tickvals: sent_per_day_json.ticks, showgrid: true }, yaxis: { showticklabels: false }, autosize: true }}
                useResizeHandler
                style={{ width: '100%' }}
              />
              )
          ...
          <section id="cta" className="main special">
            ...
            </header>
            {
              ...
              <Plot
                data={[{
                  lat: geo_loc_json.lat,
                  lon: geo_loc_json.lon,
                  mode: 'markers',
                  type: 'scattergeo',
                  marker: { size: 4, color: geo_loc_json.colors },
                  text: geo_loc_json.users,
                }]}
                layout={{
                  autosize: true,
                  hovermode: 'closest',
